...
type Store struct {
	APIGatewayV2APIs         *corestore.Collection
	APIGatewayV2Integrations *corestore.Collection
	APIGatewayV2Routes       *corestore.Collection
	APIGatewayV2Stages       *corestore.Collection
...
func NewStore(runtimeStore *corestore.Store) Store {
	return Store{
		APIGatewayV2APIs:         runtimeStore.MustCollection("aws.apigatewayv2_apis", "account_id", "region", "api_id", "name"),
		APIGatewayV2Integrations: runtimeStore.MustCollection("aws.apigatewayv2_integrations", "account_id", "region", "api_id", "integration_id"),
		APIGatewayV2Routes:       runtimeStore.MustCollection("aws.apigatewayv2_routes", "account_id", "region", "api_id", "route_id", "route_key"),
		APIGatewayV2Stages:       runtimeStore.MustCollection("aws.apigatewayv2_stages", "account_id", "region", "api_id", "stage_name"),
