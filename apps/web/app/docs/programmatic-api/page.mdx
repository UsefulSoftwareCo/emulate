...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Allow AWS Lambda Node.js ZipFile code to run locally for invokes signed by a known AWS access key.</td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>@emulators/aws</code></td><td>AWS S3, SQS, SNS, EventBridge, DynamoDB, CloudWatch Logs, Secrets Manager, SSM Parameter Store, KMS, Lambda, IAM, STS</td></tr>
