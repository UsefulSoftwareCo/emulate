...
const graphOperations: OperationCoverage[] = [
  ...
  { operationId: "message_Get", method: "GET", path: "/v1.0/me/messages/:id", status: "hand-authored" },
  {
    ...
    status: "partial",
    summary: "JSON drafts with file attachments under 3 MB.",
  },
  {
    ...
    status: "partial",
    summary: "Draft subject, body, sender and recipients; attachments use their own endpoint.",
  },
  {
    operationId: "message_CreateReply",
    method: "POST",
    path: "/v1.0/me/messages/:id/createReply",
    status: "partial",
    summary: "JSON reply drafts retain conversationId and use replyTo; quoted original body is not generated.",
  },
  {
    ...
    status: "partial",
    summary: "Move draft to sent items with a stable ID and an empty 202 response; no external delivery.",
  },
  {
    ...
    status: "partial",
    summary: "File attachments under 3 MB on drafts; no upload sessions or item/reference attachments.",
  },
  {
    ...
    path: "/v1.0/me/messages/:id/attachments",
    status: "partial",
    summary: "Stored file attachments; OData query options are not implemented.",
  },
  {
    operationId: "attachment_Get",
    method: "GET",
    path: "/v1.0/me/messages/:id/attachments/:attachmentId",
    status: "hand-authored",
  },
  {
    operationId: "attachment_GetContent",
    method: "GET",
    path: "/v1.0/me/messages/:id/attachments/:attachmentId/$value",
    status: "hand-authored",
  },
