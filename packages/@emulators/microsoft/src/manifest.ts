...
const graphOperations: OperationCoverage[] = [
  ...
  {
    operationId: "driveItem_CreateRootChild",
    method: "POST",
    path: "/v1.0/me/drive/root/children",
    status: "hand-authored",
  },
  {
    operationId: "driveItem_PutPathContent",
    method: "PUT",
  ...
  {
    operationId: "driveItem_GetContent",
    method: "GET",
    path: "/v1.0/me/drive/items/:id/content",
    status: "hand-authored",
  },
  {
    operationId: "driveItem_PutContent",
    method: "PUT",
    path: "/v1.0/me/drive/items/:id/content",
    status: "hand-authored",
  },
  ...
  { operationId: "drive_Get", method: "GET", path: "/v1.0/drives/:driveId", status: "hand-authored" },
  {
    operationId: "driveItem_GetDriveRoot",
    method: "GET",
    path: "/v1.0/drives/:driveId/root",
    status: "hand-authored",
  },
  {
    operationId: "driveItem_ListDriveRootChildren",
    method: "GET",
    path: "/v1.0/drives/:driveId/root/children",
    status: "hand-authored",
  },
  {
    operationId: "driveItem_CreateDriveRootChild",
    method: "POST",
    path: "/v1.0/drives/:driveId/root/children",
    status: "hand-authored",
  },
  {
    operationId: "driveItem_GetDriveItem",
    method: "GET",
    path: "/v1.0/drives/:driveId/items/:itemId",
    status: "hand-authored",
  },
  {
    operationId: "driveItem_UpdateDriveItem",
    method: "PATCH",
    path: "/v1.0/drives/:driveId/items/:itemId",
    status: "hand-authored",
  },
  {
    operationId: "driveItem_DeleteDriveItem",
    method: "DELETE",
    path: "/v1.0/drives/:driveId/items/:itemId",
    status: "hand-authored",
  },
  {
    operationId: "driveItem_ListDriveChildren",
    method: "GET",
    path: "/v1.0/drives/:driveId/items/:itemId/children",
    status: "hand-authored",
  },
  {
    operationId: "driveItem_GetDriveContent",
    method: "GET",
    path: "/v1.0/drives/:driveId/items/:itemId/content",
    status: "hand-authored",
  },
  {
    operationId: "driveItem_PutDriveContent",
    method: "PUT",
    path: "/v1.0/drives/:driveId/items/:itemId/content",
    status: "hand-authored",
  },
  {
    operationId: "driveItem_PutDrivePathContent",
    method: "PUT",
    path: "/v1.0/drives/:driveId/items/root:/:path:/content",
    status: "hand-authored",
  },
  ...
  seedSchema: {
    ...
    fields: [
      ...
      },
      {
        ...
        title: "Drive items",
        description:
          "Seeded OneDrive files and folders returned from /v1.0/me/drive. The content seed key accepts a UTF-8 string; runtime Graph content uploads preserve binary bytes.",
